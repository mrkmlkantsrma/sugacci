...
<footer>Powered by <a href="https://google.com/">Sugacci</a></footer>
<?php } ?>
</div>
<!-- Modal Calculator -->
...
<script src="<?= base_url('assets/admin/admin-theme/vendors/js/vendors.min.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/admin/admin-theme/js/core/app-menu-lite.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/admin/admin-theme/js/core/app-lite.js') ?>" type="text/javascript"></script>
<script>
    var urls = {
