...
<div class="row">
    <div class="col-sm-8 col-md-7">
        ...
        <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group"> 
                    <label>Product </label>
                    <input type="text" name="product" value="<?php echo set_value('product');?>" class="form-control">
                </div>
                <div class="form-group"> 
                    <label>Discount </label>
                    <input type="text" name="discount" value="<?php echo set_value('discount');?>" class="form-control">
                </div>
                <div class="form-group"> 
                    <label>End Date </label>
                    <input type="date" name="end_date" value="<?php echo set_value('end_date');?>" class="form-control">
                </div>

                <div class="form-group bordered-group">
                <?php
                    if (isset($_POST['image']) && $_POST['image'] != null) {
                        $image = 'attachments/deal_images/' . htmlspecialchars($_POST['image']);
