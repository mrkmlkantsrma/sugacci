    ...
    <div class="content-header-right col-md-8 col-12">
        <div class="breadcrumbs-top float-md-right">
            <div class="breadcrumb-wrapper mr-1">
                ...
                <li class="breadcrumb-item active">Instagram
                </li>
                </ol>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <a href="<?= base_url('admin/instapublish') ?>" class="btn btn-primary btn-xs pull-right" style="margin-bottom:10px;"><b>+</b> Add Instagram Post</a>
                    </div>
    ...
    <div class="col-sm-6">
        <form method="GET">
            ...
            <?php// if (isset($_GET['search'])) { ?>
                <a href="<?php // echo base_url('admin/instagrams') ?>">Clear search</a>
            <?php// } ?>
        </form>
    </div>
</div> -->
    ...
    <div class="row">
        <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            foreach ($Instagrams as $row) {
                                $u_path = 'attachments/instagram_images/';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('admin/blog/instaPublish/edit/' . $row['id']) ?>" class="btn btn-info">Edit</a>
                                            <a href="<?= base_url('admin/instagram?delete=' . $row['id']) ?>"  class="btn btn-danger confirm-delete">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
