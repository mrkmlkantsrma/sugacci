    ...
    <div class="content-header-right col-md-8 col-12">
        <div class="breadcrumbs-top float-md-right">
            <div class="breadcrumb-wrapper mr-1">
                ...
                <li class="breadcrumb-item active"> Add youtube Posts
                </li>
                </ol>
            </div>
        </div>
...
<!--  Add youtube section start -->
<section id="add-youtube">
<!--  Add youtube -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Add youtube Post</h4>
    ...
    <div class="col-sm-8 col-md-7">
        ...
        <form method="POST" enctype="multipart/form-data">
                <div class="form-group"> 
                    ...
                    <input type="text" name="youtube_title" value="<?php echo set_value('youtube_title');?>" class="form-control">
                </div>
                <div class="form-group"> 
                    <label>Post Url </label>
                    <input type="text" name="youtube_url" value="<?php echo set_value('youtube_url');?>" class="form-control">
                </div>
