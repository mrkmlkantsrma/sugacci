    ...
    <div class="col-sm-8 col-md-7">
        ...
        <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group bordered-group">
                    <?php
                    if (isset($test['image']) && $test['image'] != null) {
                        $image = 'attachments/testimonial_images/'.htmlspecialchars($test['image']);
                        ...
                        <input type="hidden" name="image" value="<?= htmlspecialchars($test['image']) ?>">
                <?php    
                    }
                    ?>
