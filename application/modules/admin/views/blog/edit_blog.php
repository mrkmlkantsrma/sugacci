    ...
    <div class="col-sm-8 col-md-7">
        ...
        <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group"> 
                    <label>Title </label>
                    <input type="text" name="name" value="<?php echo $blog['name'];?>" class="form-control">
                </div>
                <div class="form-group"> 
                    <label>Author </label>
                    <input type="text" name="author" value="<?php echo $blog['author'];?>" class="form-control">
                </div>
                <div class="form-group">
                    <label for="description">Description </label>
                    <textarea name="description" id="description" rows="50" class="form-control"><?php echo $blog['description'];?></textarea>
                    <script>
                ...
                <div class="form-group bordered-group">
                    ...
                    if (isset($blog['image']) && $blog['image'] != null) {
                        $image = 'attachments/blog_images/'.htmlspecialchars($blog['image']);
                        ...
                        <input type="hidden" name="image" value="<?= htmlspecialchars($blog['image']) ?>">
                <?php    
                    }
                    ?>
                    <label for="userfile">Blog Thumbnail Image</label>
